...
const AppShowcase = () => {
  ...
  return (
    <section className="py-24 bg-background relative overflow-hidden">
      ...
      <div ref={showcaseRef} className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-text-secondary leading-relaxed">
                Join millions of learners worldwide who have transformed their education 
                with ACADEMe's AI-powered platform. Available on all devices.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-surface/50 backdrop-blur-sm border border-border rounded-xl p-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-text-secondary text-sm">App Store Rating</div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-surface/50 backdrop-blur-sm border border-border rounded-xl p-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="text-2xl font-bold text-text-primary">1M+</div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="group bg-text-primary hover:bg-text-primary/90 text-background px-6 py-3 rounded-xl transition-all duration-300 transform hover:scale-105 flex items-center space-x-3 font-semibold">
                ...
                <div className="w-full h-[600px] bg-gradient-to-br from-surface to-background rounded-[2.5rem] overflow-hidden relative">
                  ...
                  <div className="p-6 space-y-6">
                    <div className="flex items-center justify-between">
                      <h3 className="text-text-primary font-bold text-lg">Dashboard</h3>
                    ...
                    <div className="space-y-4">
                      <div className="bg-surface/50 border border-border rounded-xl p-4">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-text-primary font-semibold">Mathematics</span>
                          <span className="text-text-secondary text-sm">85%</span>
                        </div>
                      ...
                      <div className="bg-surface/50 border border-border rounded-xl p-4">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-text-primary font-semibold">Physics</span>
                          <span className="text-text-secondary text-sm">92%</span>
                        </div>
                        <div className="w-full bg-border rounded-full h-2">
                      ...
                      <div className="bg-surface/50 border border-border rounded-xl p-4">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-text-primary font-semibold">Chemistry</span>
                          <span className="text-text-secondary text-sm">78%</span>
                        </div>
                        <div className="w-full bg-border rounded-full h-2">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="bg-surface/50 border border-border rounded-xl p-3 text-center">
                        ...
                        <div className="text-text-secondary text-xs">Achievements</div>
                      </div>
                    </div>
                  </div>
                </div>
