...
- [x] Character sheet `design/mascot/mascot_academe.png`  
- [x] Internal name Pebby (spare use in UI)  
- [ ] Expression → state catalog mapping  
- [ ] Rive / transparent WebM  
- [ ] App MascotSlot  

---

# After 0.8 → Phase 1 app

See product roadmap Phase 1 feature list.
